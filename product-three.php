                        ...
                        <div class="row">
                                ...
                                <div class="single-product-scroll">
                                    <div class="single-product-cover">
                                        <div class="single-slide zoom-image-hover">
                                            <img class="img-responsive" src="assets/images/product-image/1_1.jpg"
                                                alt="">
                                        </div>
                                        <div class="single-slide zoom-image-hover">
                                            <img class="img-responsive" src="assets/images/product-image/1_1.jpg"
                                    ...
                                    <div class="single-nav-thumb">
                                        <div class="single-slide">
                                            <img class="img-responsive" src="assets/images/product-image/1_2.jpg"
                                                alt="">
                                        </div>
                                        <div class="single-slide">
                                            <img class="img-responsive" src="assets/images/product-image/1_2.jpg"
                            ...
                            <div class="single-pro-desc">
                                <div class="single-pro-content">
                                    <h5 class="ec-single-title" id="product-title">Cute Baby Toy's</h5>
                                    ...
                                    <div class="ec-single-desc">Cute baby toys are soft, colorful, and designed for little hands. They stimulate sensory development, encourage fine motor skills, and often make sounds, offering safe, engaging fun for babies to explore.</div>

                                    <div class="ec-single-price-stoke">
                                        <div class="ec-single-price">
                                            <span class="ec-single-ps-title">As low as</span>
                                            <span class="new-price" id="product-price">Rs. 400.00</span>
                                        </div>
                                    </div>
                                    ...
                                    <?php
                                        ...
                                        <?php if ($product_in_cart): ?>
                                            <div class="cart-qty-plus-minusps">
                                                ...
                                                <input class="cart-plus-minus" type="text" id="cart-qty-input3" name="cartqtybutton" value="<?php echo htmlspecialchars($item['qty']); ?>" readonly />
                                                <button type="button" class="qty-plus" onclick="updateQty(1)">+</button>
                                                <input type="hidden" id="product-id3" value="<?= $product_id; ?>" />
                                            </div>
                                        ...
                                        <div class="qty-plus-minus">
                                            ...
                                            <input type="hidden" id="product1" value="3">
                        ...
                        <div class="tab-content  ec-single-pro-tab-content">
                            <div id="ec-spt-nav-details" class="tab-pane fade show active">
                                <div class="ec-single-pro-tab-desc">
                                    <p>Cute baby toys come in various forms like soft plush animals, rattles, and colorful stacking rings. They’re designed to be safe, lightweight, and engaging for infants. With bright colors, textures, and gentle sounds, these toys support sensory development, motor skills, and curiosity, keeping babies entertained and learning.
                                    </p>
                                    <ul>
        ...
        <div class="row margin-minus-b-30">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6 pro-gl-content">
                <div class="ec-product-inner">
                    ...
                    <div class="ec-pro-content">
                        <h5 class="ec-pro-title"><a href="product-two.php">Full Sleeve Shirt</a></h5>
                        <div class="ec-pro-rating">
                            <i class="ecicon eci-star fill"></i>
                            <i class="ecicon eci-star fill"></i>
                            <i class="ecicon eci-star fill"></i>
                        ...
                        <a href="product-two.php" class="ec-single-cart">
                            <button class="btn">Quick View</button>
                        </a>
                    </div>
                </div>
...
function updateQty(change) {
    var qtyInput = document.getElementById('cart-qty-input3');
    ...
    var product_id = document.getElementById('product-id3').value;
