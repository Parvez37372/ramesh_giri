                        ...
                        <div class="row">
                            ...
                            <div class="single-pro-desc">
                                <div class="single-pro-content">
                                    <h5 class="ec-single-title" id="product-title">Unisex Cotton Neck Hoodie</h5>
                                    ...
                                    <div class="ec-single-desc">A unisex cotton neck hoodie offers comfort and style for all. Made from soft, breathable cotton, it features a cozy hood, versatile fit, and is ideal for layering in cooler weather.</div>

                                    <div class="ec-single-price-stoke">
                                        <div class="ec-single-price">
                                            <span class="ec-single-ps-title">As low as</span>
                                            <span class="new-price" id="product-price">Rs. 399.00</span>
                                        </div>
                                    </div>
                                    ...
                                    <?php
                                        ...
                                        <?php if ($product_in_cart): ?>
                                            ...
                                            <div class="cart-qty-plus-minusps">
                                                ...
                                                <input class="cart-plus-minus" type="text" id="cart-qty-input1" name="cartqtybutton" value="<?php echo htmlspecialchars($item['qty']); ?>" readonly />
                                                <button type="button" class="qty-plus" onclick="updateQty(1)">+</button>
                                                <input type="hidden" id="product-id1" value="<?= $product_id; ?>" />
                                            </div>
                                        ...
                                        <div class="qty-plus-minus">
                                            ...
                                            <input type="hidden" id="product1" value="1">
                        ...
                        <div class="tab-content  ec-single-pro-tab-content">
                            <div id="ec-spt-nav-details" class="tab-pane fade show active">
                                <div class="ec-single-pro-tab-desc">
                                    <p>A unisex cotton neck hoodie combines comfort with style, suitable for all genders. Made from soft, breathable cotton, it offers warmth without bulk. The design features a relaxed fit, adjustable hood, and ribbed cuffs for a cozy feel. Ideal for casual wear, it’s a versatile choice for year-round layering.
                                    </p>
                                    <ul>
...
function updateQty(change) {
    var qtyInput = document.getElementById('cart-qty-input1');
    ...
    var product_id = document.getElementById('product-id1').value;
