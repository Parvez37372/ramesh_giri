                        ...
                        <div class="row">
                            ...
                            <div class="single-pro-desc">
                                <div class="single-pro-content">
                                    <h5 class="ec-single-title" id="product-title">Jumbo Carry Bag</h5>
                                    ...
                                    <div class="ec-single-desc">The Jambo carry bag is a versatile, durable bag perfect for travel or daily use, featuring spacious compartments, sturdy handles, and stylish design, providing both functionality and comfort for on-the-go needs.</div>

                                    <div class="ec-single-price-stoke">
                                        <div class="ec-single-price">
                                            <span class="ec-single-ps-title">As low as</span>
                                            <span class="new-price" id="product-price">Rs. 529.00</span>
                                        </div>
                                    </div>
                                    ...
                                    <?php
                                        ...
                                        <?php if ($product_in_cart): ?>
                                            <div class="cart-qty-plus-minusps">
                                                ...
                                                <input class="cart-plus-minus" type="text" id="cart-qty-input4" name="cartqtybutton" value="<?php echo htmlspecialchars($item['qty']); ?>" readonly />
                                                <button type="button" class="qty-plus" onclick="updateQty(1)">+</button>
                                                <input type="hidden" id="product-id4" value="<?= $product_id; ?>" />
                                            </div>
                                        ...
                                        <div class="qty-plus-minus">
                                            ...
                                            <input type="hidden" id="product1" value="4">
                        ...
                        <div class="tab-content  ec-single-pro-tab-content">
                            <div id="ec-spt-nav-details" class="tab-pane fade show active">
                                <div class="ec-single-pro-tab-desc">
                                    <p>The Jambo carry bag is a versatile, durable travel bag ideal for on-the-go use. With its spacious interior, multiple compartments, and reinforced handles, it offers convenience and organization. Made from high-quality materials, it withstands wear and tear, making it perfect for daily commuting or extended trips.
                                    </p>
                                    <ul>
...
function updateQty(change) {
    var qtyInput = document.getElementById('cart-qty-input4');
    ...
    var product_id = document.getElementById('product-id4').value;
